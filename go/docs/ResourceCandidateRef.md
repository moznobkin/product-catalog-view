...
**Href** | **string** | Reference of the resource candidate | [optional] [default to null]
**Id** | **string** | Unique identifier of the resource candidate | [default to null]
**Name** | **string** | Name of the resource candidate | [optional] [default to null]
**Version** | **string** | Version of the resource candidate | [optional] [default to null]
